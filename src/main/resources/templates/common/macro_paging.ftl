...
<#macro paging page param action>
    ...
    <div>
        ...
        当前第<span style='color: #FD7B02;'>${page.pageIndex}</span> 页，
        每页 ${page.pageSize} 条数据
        &nbsp;到第<input style="text-align:center;width:3em;color: #000;" class="w20 mar0 alignCenter" onblur="navigatorPage(parseInt(this.value))" maxlength="5" type="text" value="${pageIndex + 1}"style="width:40px"> 页
    </div>
